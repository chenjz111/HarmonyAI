...
-- Keep the historical 0003 checksum unchanged and remove only its obsolete
-- no-goal CHECK in this additive migration.
ALTER TABLE assessment_v3 RENAME TO assessment_v3_goal_old;
...
SELECT
    ...
    flow_contract_version, input_revision, input_mode,
    safety_policy, safety_evaluation_status, created_at, updated_at
FROM assessment_v3_goal_old;

DROP TABLE assessment_v3_goal_old;
