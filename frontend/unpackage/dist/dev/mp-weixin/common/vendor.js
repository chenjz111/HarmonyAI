...
function initRuntimeSocketService() {
  const hosts = "192.168.72.1,192.168.174.1,192.168.3.234,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_fHU0rH";
...
function getVue3TitleMap() {
  ...
  titleMapCache = {};
  try {
    const raw = '{"pages/index/index":"HarmonyAI","pages/emotion/emotion":"情绪选择","pages/survey/survey":"健康评估","pages/player/player":"疗愈播放"}';
...
function getEnvAppName() {
  var _a;
  return (_a = "HarmonyAI") !== null && _a !== void 0 ? _a : "";
}
